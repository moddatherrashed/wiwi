        ...
        return (
            <View style={{ backgroundColor: 'white', flex: 1 }}>
                <View style={{ flexDirection: 'column' }}>
                    <Text style={{ fontWeight: '700', padding: 20, fontSize: 18 }}>{I18nManager.isRTL ? translation.ar.mobile_number : translation.en.mobile_number}</Text>
                    <TouchableOpacity>
                ...
                <View style={{ flexDirection: 'column' }}>
                    <Text style={{ fontWeight: '700', padding: 20, fontSize: 18 }}>{I18nManager.isRTL ? translation.ar.email : translation.en.email}</Text>
                    <TouchableOpacity>
                ...
                <View >
                    <Text style={{ fontWeight: '700', padding: 20, fontSize: 18 }}>{I18nManager.isRTL ? translation.ar.our_social_media : translation.en.our_social_media}</Text>
